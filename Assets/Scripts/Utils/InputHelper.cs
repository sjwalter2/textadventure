...
public class InputHelper : MonoBehaviour
{
	...
	public static bool GetNoMovementDirection()
	{
		if(!(Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D) ||
		     Input.GetKey(KeyCode.UpArrow)|| Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.LeftArrow)|| Input.GetKey(KeyCode.RightArrow))) {return true;}
		return false;
	}
}